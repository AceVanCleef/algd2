...
public final class Configuration {
	...
	public static void populateDataPresetterDirectory() {
		DataPresetterDirectory.add("Set Reverse",
				"ch.fhnw.algd.sortdemo.presets.SetReverseData");
		DataPresetterDirectory.add("Set Special Case 1",
				"ch.fhnw.algd.sortdemo.presets.SetWorstCaseData");
		DataPresetterDirectory.add("Set Special Case 2",
				"ch.fhnw.algd.sortdemo.presets.SetWorstCaseDataSymmetric");
	}
}
